...

{
    ...
    _shrinkViewKeyboardWillChangeFrameObserver = [nc addObserverForName:UIKeyboardWillChangeFrameNotification
                                                             ...
                                                             usingBlock:^(NSNotification* notification) {
                                                                 ...
                                                                 [weakSelf performSelector:@selector(shrinkViewKeyboardWillChangeFrame:) withObject:notification afterDelay:0.1];
...

{
    ...
    if (!(self.viewController.isViewLoaded && self.viewController.view.window)) {
        ...
        //NSLog(@"&&&&&&&&&&&&&&&&&:: setShrinkView : VIEW IS NOT LOADED!! ");
    ...
    if ([self settingForKey:@"StatusBarOverlaysWebView"] != nil && ![[self settingForKey:@"StatusBarOverlaysWebView"] boolValue]) {
        ...
        //NSLog(@"&&&&&&&&&&&&&&&&&:: setShrinkView : Status bar overlays WebView! ");
    ...
    if (CGRectContainsRect(screen, keyboardIntersection) && !CGRectIsEmpty(keyboardIntersection) && _shrinkView && self.keyboardIsVisible) {
        ...
        //NSLog(@"&&&&&&&&&&&&&&&&&:: setShrinkView : Resize required, configuring screen height! ");
    ...
    //SCROLL DEST:  129 168 45 111

    //SCROLL DEST:  -26 428 -240 -19
...

    {
        ...
        //NSLog(@"&&&&&&&&&&&&&&&&&:: setShrinkView : shouldAnimate is FALSE : Dispatching new frame size!! ");
        ...
        //NSLog(@"&&&&&&&&&&&&&&&&&:: setShrinkView : shouldAnimate is TRUE : Continue... ");
    ...
    if (isGrowing) {
        ...
        //NSLog(@"&&&&&&&&&&&&&&&&&:: setShrinkView : VIEW IS GROWING : Dispatching new frame size!! ");
